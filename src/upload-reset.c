...
int   openserial(char *devicename, int baudrate);
...
int main(int argc, char *argv[])
{
	...
	if (argc<3 || argc >4)
	{
		printf("Usage upload-reset <serial_device> <baud_rate> <Optional_delay_in_milliseconds>\n\r");
		return 0;
	}

 	if (openserial(argv[1], atol(argv[2])))
	{
